...
uint8_t unpackR(uint32_t packed) { return (uint8_t) (packed >> 16); }

uint8_t unpackG(uint32_t packed) { return (uint8_t) (packed >> 8); }

uint8_t unpackB(uint32_t packed) { return (uint8_t) (packed); }
